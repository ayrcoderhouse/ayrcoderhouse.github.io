            ...
            $(emptyCol).append(
                $(card).append(
                    ...
                    $(cardBody).append(
                        ...
                        $(cardText).text(products[0].price.toFixed(2) + " $")
                    )
                )
            )
        )
...
function showProduct() {
    ...
    $("#details_price").text(product.price.toFixed(2) + " $");
        ...
        for (let j = 0; j < cartsProducts.length; j++) {
            ...
            $("#summary_products").append(
                $(emptyCol).append(
                    ...
                    $('<small class="col-7 float-right d-block">').text(cartsProducts[j].price.toFixed(2)+"$"),
